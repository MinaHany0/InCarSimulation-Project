...
const Dio_ConfigType Dio_Configuration = {
                                              DioConf_DCM_IN1_PORT_NUM,DioConf_DCM_IN1_CHANNEL_NUM,
                                              DioConf_DCM_ENB_PORT_NUM,DioConf_DCM_ENB_CHANNEL_NUM,
                                              DioConf_FAN_IN1_PORT_NUM,DioConf_FAN_IN1_CHANNEL_NUM,
                                              DioConf_FAN_ENA_PORT_NUM,DioConf_FAN_ENA_CHANNEL_NUM
				         };